...
git clone --depth=1 https://github.com/jhsystemswll/odoo-17-docker-compose $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: jhsystems.net | Live chat port: $CHAT"